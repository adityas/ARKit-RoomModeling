...
## Conclusion
Despite the challenges and mistakes made in the execution of this project, overall there were some good learnings and takeaways and a potential path forward. It was also fun working on a new and exciting platform that is still relatively unexplored.
